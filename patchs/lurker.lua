--DSHAD Here, did a small modif (rxi-lume) so that the original script can get loaded by lovely
--Original from https://github.com/rxi/lurker
...
-- as a global
local lume = rawget(_G, "rxi-lume") or require((...):gsub("[^/.\\]+$", "rxi-lume"))
